...
3. **Миграция `0025` не применена.** Без неё не работают жалобы и вкладка
   «Жалобы» в админке: таблицы `content_reports` и функции
   `admin_delete_review` в живой базе ещё нет.
