        ...
        Row(
          children: [
            ...
            TextButton.icon(
              ...
              // Раньше форма открывалась и гостю: он заполнял её, а отправка
              // падала на политике supplier_reviews (запись только
              // authenticated). Спрашиваем вход до формы, как в отзывах
              // о товаре.
